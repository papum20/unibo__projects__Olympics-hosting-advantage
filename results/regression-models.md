...
* repeat M significance (rvalue low but visible change, some vars change esp. post a lot, host little) (esp. from 1996, also earlier years for added results)
...
* show M perc diff, it's better, it hides effect of Y:
  * TODO
* close
