\subsection{Analisi Within Country e Test dei Segni}\label{sec:methods_within_country}
...
fuori.\\
Un'analisi within-country ha calcolato le differenze.\\
...
rispettivamente, una distribuzione normale dei dati e una simmetria delle
differenze.